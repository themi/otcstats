// Inspired by: https://github.com/Honatas/bootstrap-4-autocomplete
...
(function ($) {
        ...
        $.ajax({
            ...
            success: function(json){
                $.each(json, function (i, row) {
                    opts.source[row[opts.fieldname]] = row[opts.fieldname]
                });
            }
        });
    }
    $.fn.autocompleter = function (options) {
        ...
        var _field = $(this);
        opts.url = _field.data("url");
        opts.fieldname = _field.data("fieldname");
        populateSource(opts);
        // clear previously set autocompleter
        ...
        this.off('click.autocompleter').click('click.autocompleter', function (e) {
        ...
        // show options
        this.off('keyup.autocompleter').keyup('keyup.autocompleter', function () {
            if (createItems(_field, opts) > 0) {
